                ...
                <div className="flex bg-[#826fffa9] backdrop-blur-md  h-full rounded-full shadow-xl">
                    ...
                    <div className="flex flex-col">
                        <div className="flex w-full gap-10 px-14 pt-4">
                            <a className="flex pr-48 font-semibold text-4xl text-transparent bg-clip-text bg-gradient-to-r from-[#211951] to-[#F0F3FF] ml-9"> 1+</a>
                            <a className="flex pr-48 ps-6 font-semibold text-4xl text-transparent bg-clip-text bg-gradient-to-r from-[#211951] to-[#F0F3FF]"> 20+ </a>
                            <a className="flex ps-8 font-semibold text-4xl text-transparent bg-clip-text bg-gradient-to-r from-[#211951] to-[#F0F3FF]"> 10+</a>
                        </div>
