        ...
        <section className="lg:py-16">
                ...
                <div>
                    ...
                    >
                        <div className=" text-3xl sm:text-5xl lg:text-7xl lg:leading-normal font-extrabold ">
                            ...
                            <span className="pl-2 text-[#15F5BA] lg:text-6xl">
                                I&apos;m{" "}
                            </span>
                            <div>
                                <TypeAnimation
            ...
            >
                <div>
                    <Link
                        href="/#contact"
                        className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-[#15F5BA] hover:bg-slate-200 text-[#211951] font-semibold"
                    >
                        Hire Me
                    </Link>
                    <Link
                        href="/"
                        className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-[#15F5BA] hover:bg-slate-800 text-white mt-3 font-semibold"
                    >
                        <span className="block bg-[#FFF6F4] hover:bg-slate-200 rounded-full px-5 py-2 text-[#211951]">
                            Download CV
                        </span>
                    </Link>
                </div>
