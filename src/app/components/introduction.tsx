...
const HeroSection = () => {
    return (
        <section className="lg:py-16  ">
            <div className="relative flex flex-col-1 w-full h-full z-[20] bg-[#211951]">
                <div>
                    <motion.div
                        initial={{ opacity: 0, scale: 0.5 }}
                        animate={{ opacity: 1, scale: 1 }}
                        transition={{ duration: 1 }}
                        className="flex place-self-center text-center sm:text-left justify-self-center z-[20] pt-32"
                    >
            ...
            <div className="flex w-full h-full bg-[#211951] items-center justify-center flex-col">
                <motion.div
                    initial={{ opacity: 0, scale: 0.5 }}
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ duration: 1 }}
                    className="flex place-self-center text-center sm:text-left justify-self-center z-[20]"
                >
                ...
                <div className="flex  bg-[#211951] items-center justify-center z-[20]">
                    <motion.div
                        initial={{ opacity: 0, scale: 0.5 }}
                        animate={{ opacity: 1, scale: 1 }}
                        transition={{ duration: 1 }}
                    ...
                    >
                        <div className="relative flex  flex-row">
                            ...
                            <Link
                                href="/"
                                className="px-1 inline-block py-1 w-full sm:w-fit rounded-full bg-[#15F5BA] hover:bg-[#211951ba] text-white mt-3 font-semibold z-[30]"
                            >
                                <span className="block bg-[#FFF6F4] hover:bg-[#15F5BA] font-semibold rounded-full px-5 py-2 text-[#211951] z-[30]">
                                    Download CV
                                </span>
                            </Link>
                        </div>
